...
4. Display the first three characters of LAST_NAME from the Employee Table.
5. Display the unique values of DEPARTMENT from the Employee Table and print its length.
6. Display the FIRST_NAME and LAST_NAME from the Employee Table into  single column as FULL_NAME. A space char should separate them.
